...
TABLE_METADATA: dict = {
    ...
    "bluecoat_proxy_logs": {
        ...
        "columns": {
            ...
            "url_host":              "TEXT      — domain name of the requested URL (e.g. youtube.com, salesforce.com, github.com). This is a website domain — NOT a country, city, or location field. Do NOT use this column for geographic filtering.",
            ...
            "proxy_appliance":       "TEXT      — internal hardware appliance ID assigned to the proxy node (e.g. 'ProxySG-MUM-01'). This is a system identifier only — NOT a location or country field. Do NOT use this column to filter by country or city.",
